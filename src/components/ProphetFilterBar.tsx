...
interface ProphetFilterBarProps {
  selectedEra: ProphetEraId | 'all'
  searchQuery: string
  onEraChange: (era: ProphetEraId | 'all') => void
  onSearchChange: (query: string) => void
}

export default function ProphetFilterBar({
  selectedEra,
  searchQuery,
  onEraChange,
  onSearchChange,
}: ProphetFilterBarProps) {
  const eraButtons = [
